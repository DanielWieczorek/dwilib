...
${OBJECTDIR}/src/dwiarray.o: src/dwiarray.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dwiarray.o src/dwiarray.c
...
${TESTDIR}/test/dwiarray_test.o: test/dwiarray_test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/test/dwiarray_test.o test/dwiarray_test.c
...
${OBJECTDIR}/src/dwiarray_nomain.o: ${OBJECTDIR}/src/dwiarray.o src/dwiarray.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dwiarray_nomain.o src/dwiarray.c;\
	else  \
